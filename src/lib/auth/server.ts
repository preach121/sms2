 ...
 *
 * Tri-mode:
 *   - Deployed: the deployer injects a per-app `GROK_AUTH_*` + `""BETTER_AUTH_URL")?.replace(/\/+$/, ""); const VERCEL_ORIGINS: string[] = [   "https://*.vercel.app",   "https://sms2-fvfa.vercel.app", ];")?.replace(/\/+$/, ""); const VERCEL_ORIGINS: string[] = [   "https://*.vercel.app",   "https://sms2-fvfa.vercel.app", ];`
...
const explicitBaseURL = env(""BETTER_AUTH_URL")?.replace(/\/+$/, ""); const VERCEL_ORIGINS: string[] = [   "https://*.vercel.app",   "https://sms2-fvfa.vercel.app", ];");
...
const trustedOrigins: string[] = explicitBaseURL
  ? [explicitBaseURL, ...? [explicitBaseURL, ...LOCAL_DEV_ORIGINS, ...VERCEL_ORIGINS]
  : [
